...
export const LinearProgressBar = () => {
    ...
    const currentLeftMenuSelection = categories.find((category: any) => category?.selectedId === currentSelectedId)
    const progressValuePerc = Math.round(currentLeftMenuSelection?.totalAnswered / currentLeftMenuSelection?.totalQues * 100);
        ...
        <div className="progressbar-container">
            ...
            >
                ...
                <Box className="progressbar-text" sx={{ minWidth: 35 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">{`(${Math.round(progressValuePerc)}%)`}</Typography>
                </Box>
            </Box>
        </div>
    )
